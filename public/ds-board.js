...
(function () {
  ...
  function injectStyle() {
    ...
    ${S} .sumhead{font-size:14px;font-weight:700;color:#1B2230;line-height:1.5;margin-bottom:12px;padding-bottom:10px;border-bottom:1px solid #EEF1F5}
    ${S} .sumtip{font-size:11.5px;color:#B0B8C4}
    ${S} .sumfoot{margin-top:12px;padding-top:10px;border-top:1px solid #F1F4F8;font-size:11.5px;color:#94A3B8;display:flex;gap:12px;align-items:center;flex-wrap:wrap}
    ${S} .sumfoot a{color:#2E5BD8;text-decoration:none;margin-left:auto}
    ...
    ${S} .sumsrc{font-size:11px;color:#94A3B8;margin-top:7px}
    ...
    const s = document.createElement("style"); s.id = "ds-style"; s.dataset.ver = VER; s.textContent = css; document.head.appendChild(s);
  }
